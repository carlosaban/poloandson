...
namespace SUIT.Pago.DA
{
    public class DA_Invoice
    {
        ...
        public VE_Invoice updateInvoice(VE_Invoice _VeInvoice)
        {
            ...
            parameters.Add("_SourceStore", string.IsNullOrWhiteSpace(_VeInvoice.SourceStore) ? DBNull.Value : (object)_VeInvoice.SourceStore);
            parameters.Add("_TargetStore", string.IsNullOrWhiteSpace(_VeInvoice.TargetStore) ? DBNull.Value : (object)_VeInvoice.TargetStore);
        ...
        public BE_InvoiceItem AddInvoiceItem(BE_InvoiceItem _beInvoiceItem)
        {
            ...
            parameters.Add("_IsEnabled", _beInvoiceItem.IsEnabled);
        ...
        public List<VE_Invoice> getInvoiceGeneral(BEInvoiceFilter _bEInvoiceFilter)
        {
            ...
            parameters.Add("_CompanyCodeSource", string.IsNullOrWhiteSpace(_bEInvoiceFilter.CompanyCodeSource) ? DBNull.Value : (object)_bEInvoiceFilter.CompanyCodeSource);
            parameters.Add("_CompanyCodeTarget", string.IsNullOrWhiteSpace(_bEInvoiceFilter.CompanyCodeTarget) ? DBNull.Value : (object)_bEInvoiceFilter.CompanyCodeTarget);

            parameters.Add("_invoiceIdList", string.IsNullOrWhiteSpace(_bEInvoiceFilter.invoiceIdList)?DBNull.Value: (object)_bEInvoiceFilter.invoiceIdList );
            parameters.Add("_statusList", string.IsNullOrWhiteSpace(_bEInvoiceFilter.statusList) ? DBNull.Value : (object)_bEInvoiceFilter.statusList);
            parameters.Add("_invoiceType", string.IsNullOrWhiteSpace(_bEInvoiceFilter.invoiceType) ? DBNull.Value : (object)_bEInvoiceFilter.invoiceType);
